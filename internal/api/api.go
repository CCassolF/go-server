...
import (
	...
	"github.com/ccassolf/go-server/internal/store/pgstore"
...
type Message struct {
	...
	RoomID string `json:"_"`
}

func (h apiHandler) notifyCliets(msg Message) {
	h.mu.Lock()
	defer h.mu.Unlock()
...
func (h apiHandler) handleSubscribe(w http.ResponseWriter, r *http.Request) {
	...
	slog.Info("ne client connected", "room_id", rawRoomID, "client_id", r.RemoteAddr)
...
func (h apiHandler) handleCreateRoomMessage(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		http.Error(w, "shomething went wrong", http.StatusInternalServerError)
	}
